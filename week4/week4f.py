...
def exit_app():
    dialog_result = msg.askyesno(title="Exit", message="Are you sure?")
...
# Adds an "Open..." command and underlines the first character ("O"). Shows an error message when clicked.
