...
#  Holds the selected value of the combo box.
selected_combo_item = tk.StringVar(value="Option 2") 
# Holds the selected value of the radio buttons.
selected_radio_item = tk.StringVar() 
# Holds the state of the checkbox.
checkbox_state= tk.StringVar(value="Enabled") 
# A labeled frame to contain other widgets.
...
combo1 = ttk.Combobox(frame1, width=15, textvariable=selected_combo_item,
                      state="readonly") 
combo1["values"] = ("Option 1", "Option 2")
# Two radio buttons with values "A" and "B".
radio1 = ttk.Radiobutton(frame1, text="Item 1", value="A",
                         variable="selected_radio_item")
radio2 = ttk.Radiobutton(frame1, text="Item 1", value="B",
                         variable="selected_radio_item")
# A checkbox to enable or disable button1.
checkbox1 = ttk.Checkbutton(frame1, text="Enable Button", onvalue="Enabled",
                            offvalue="Disabled",
                            variable=checkbox_state, command=checkbox_handler)
# A button that triggers button_handler.
button1 = ttk.Button(frame1, text="Send",
                     command=button_handler) # state="disabled" (normal, disabled, active)
